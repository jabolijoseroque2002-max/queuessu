...
class _InformationFormScreenState extends State<InformationFormScreen>
  ...
  String _userType = 'Student'; // User Type: Student, Graduated, or External
  String? _selectedGender; // Gender selection
  String? _age; // Age input
  String? _graduationYear; // Graduation year (for Graduated users)
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        // Show dialog for network errors and validation errors, snackbar for others
          ...
          showDialog(
            ...
            builder: (context) => AlertDialog(
              title: Row(
                children: [
                  Icon(
                    errorMessage.contains('not recognized') || errorMessage.contains('does not exist')
                        ? Icons.error_outline
                        : Icons.wifi_off,
