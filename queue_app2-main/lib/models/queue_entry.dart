class QueueEntry {
  ...
  final int batchNumber; // Batch/reset cycle number for priority handling
  ...
  final String userType; // Student, Graduated, or External (renamed from studentType)
  ...
  final int? graduationYear; // Graduation year (only if userType = 'Graduated')
  ...
  QueueEntry({
    ...
    this.batchNumber = 1, // Default to batch 1
    ...
    this.userType = 'Student', // Default to Student (can be Student, Graduated, or External)
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'user_type': userType, // Changed from student_type to user_type
  ...
  factory QueueEntry.fromJson(Map<String, dynamic> json) {
    return QueueEntry(
      ...
      batchNumber: json['batch_number'] ?? 1, // Default to 1 if not present
      ...
      userType: json['user_type'] ?? json['student_type'] ?? 'Student', // Support both old and new column names
