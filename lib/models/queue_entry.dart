class QueueEntry {
  ...
  final String userType; // Student, Graduated, or External
  ...
  final String? notes; // Additional notes or custom purpose
  ...
  factory QueueEntry.fromJson(Map<String, dynamic> json) {
    return QueueEntry(
      ...
      userType: json['user_type'] ?? json['student_type'] ?? 'Student',
