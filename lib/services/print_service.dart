              ...
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow(
                      'Purpose', 
                      entry.purpose == 'Others' && entry.notes != null 
                          ? entry.notes! 
                          : entry.purpose, 
                      font, 
                      fontBold
...
Type: ${entry.userType == 'Graduated' && entry.graduationYear != null ? '${entry.userType} (${entry.graduationYear})' : entry.userType}${entry.isPriority ? '\n\n🚀 You have priority access!\nYou will be served in the top 2 positions.' : ''}
